        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <a class="btn btn-primary" href="{{route('anticipos.agregar')}}">Agregar</a>
                    <div class="ibox-tools"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></div>
                </div>
                <div class="ibox-content">
                    <form name="formBuscar" action="{{route("anticipos.index")}}" method="get">
                        <div class="row">
                        ...
                        <tbody>
                            @foreach($anticipos as $anticipo)
                                <tr>
                                    ...
                                    <td>{{fecha_latina($anticipo->created_at) }}</td>
                                    <td data-texto="{{$anticipo->empleado}}">
                                        <a href="{{route('anticipos.mostrar',$anticipo->id)}}" title="Mostrar"><img width="17px" src="{{asset('img/iconos/mostrar.png')}}" alt="Mostrar"></a>
                                        <a data-ruta="{{route('anticipos.eliminar',$anticipo->id)}}" class="btn-eliminar" title="Eliminar"><img width="17px" src="{{asset('img/iconos/eliminar.png')}}" alt="Eliminar"></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                        ...
                        <script>
                            $(document).ready(function(){
                                $('.btn-eliminar').click(function(){
                                    ...
                                    var esEliminar = confirm('Esta seguro de eliminar el anticipo de "'+texto+'"');
                                    if(esEliminar){
