        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <a class="btn btn-primary" href="{{route('bonos.agregar')}}">Agregar</a>
                    <div class="ibox-tools"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></div>
                </div>
                <div class="ibox-content">
                    <form name="formBuscar" action="{{route("bonos.index")}}" method="get">
                        <div class="row">
                        ...
                        <tbody>
                            @foreach($bonos as $bono)
                                <tr>
                                    ...
                                    <td>{{fecha_latina($bono->created_at) }}</td>
                                    <td data-texto="{{$bono->empleado}}">
                                        <a href="{{route('bonos.mostrar',$bono->id)}}" title="Mostrar"><img width="17px" src="{{asset('img/iconos/mostrar.png')}}" alt="Mostrar"></a>
                                        <a data-ruta="{{route('bonos.eliminar',$bono->id)}}" class="btn-eliminar" title="Eliminar"><img width="17px" src="{{asset('img/iconos/eliminar.png')}}" alt="Eliminar"></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
