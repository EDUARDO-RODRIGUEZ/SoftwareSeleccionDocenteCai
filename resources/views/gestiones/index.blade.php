                            ...
                            @foreach($gestiones as $gestion)
                                <tr>
                                    ...
                                    <td data-texto="{{$gestion->nombre}}">
                                        ...
                                        <a data-ruta="{{route('gestiones.eliminar',$gestion->id)}}" class="btn-eliminar" title="Eliminar"><img width="17px" src="{{asset('img/iconos/eliminar.png')}}" alt="Eliminar"></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                        ...
                        <script>
                            $(document).ready(function(){
                                $('.btn-eliminar').click(function(){
                                    ...
                                    var esEliminar = confirm('Esta seguro de eliminar el gestion "'+texto+'"');
                                    if(esEliminar){
